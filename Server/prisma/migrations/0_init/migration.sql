...
CREATE TABLE [dbo].[Account] (
    ...
    CONSTRAINT [PK__Account__46A222CDDBFAB8A4] PRIMARY KEY CLUSTERED ([account_id])
);
...
CREATE TABLE [dbo].[Category] (
    ...
    CONSTRAINT [PK__Category__D54EE9B4C3279DBB] PRIMARY KEY CLUSTERED ([category_id])
);
...
CREATE TABLE [dbo].[Comment] (
    ...
    CONSTRAINT [PK__Comment__E79576870DB0A8B2] PRIMARY KEY CLUSTERED ([comment_id])
);
...
CREATE TABLE [dbo].[Post] (
    ...
    [created_by] VARCHAR(225),
    CONSTRAINT [PK__Post__3ED787661F804987] PRIMARY KEY CLUSTERED ([post_id])
);
...
CREATE TABLE [dbo].[Product] (
    ...
    [created_by] VARCHAR(225),
    CONSTRAINT [PK__Product__47027DF5EF1C9F27] PRIMARY KEY CLUSTERED ([product_id])
);
...
CREATE TABLE [dbo].[Role] (
    ...
    CONSTRAINT [PK__Role__760965CCD9EF49F0] PRIMARY KEY CLUSTERED ([role_id])
);
...
CREATE TABLE [dbo].[Tag] (
    ...
    CONSTRAINT [PK__Tag__4296A2B6221E5228] PRIMARY KEY CLUSTERED ([tag_id])
);
